...
echo "  full-setup         - Complete setup with all optional services (kafka, pgadmin)"
...
case "${1:-help}" in
    setup)
        ...
        docker-compose up -d postgres rabbitmq redis || print_error "Docker Compose startup failed"
        ...
        echo "  - PostgreSQL      : postgres:5432 (user: fpm_user, pass: fpm_password)"
